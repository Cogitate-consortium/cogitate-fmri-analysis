...
% Output path
output_dir = '/mnt/beegfs/XNAT/COGITATE/fMRI/phase_2/processed/bids/derivatives/gppi/glm_combined';
...
matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(2).name = 'face';
matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(2).onset = onsets(strcmp('face',conditions_cell) & (strcmp('relevant',relevance_cell) | strcmp('irrelevant',relevance_cell)));
matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(2).duration = durations(strcmp('face',conditions_cell) & (strcmp('relevant',relevance_cell) | strcmp('irrelevant',relevance_cell)));
...
matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(3).name = 'object';
matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(3).onset = onsets(strcmp('object',conditions_cell) & (strcmp('relevant',relevance_cell) | strcmp('irrelevant',relevance_cell)));
matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(3).duration = durations(strcmp('object',conditions_cell) & (strcmp('relevant',relevance_cell) | strcmp('irrelevant',relevance_cell)));
...
matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(4).name = 'letter';
matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(4).onset = onsets(strcmp('letter',conditions_cell) & (strcmp('relevant',relevance_cell) | strcmp('irrelevant',relevance_cell)));
matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(4).duration = durations(strcmp('letter',conditions_cell) & (strcmp('relevant',relevance_cell) | strcmp('irrelevant',relevance_cell)));
...
matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(5).name = 'falseFont';
matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(5).onset = onsets(strcmp('falseFont',conditions_cell) & (strcmp('relevant',relevance_cell) | strcmp('irrelevant',relevance_cell)));
matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(5).duration = durations(strcmp('falseFont',conditions_cell) & (strcmp('relevant',relevance_cell) | strcmp('irrelevant',relevance_cell)));
...
matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(6).name = 'target';
matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(6).onset = onsets(strcmp('target',relevance_cell));
matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(6).duration = durations(strcmp('target',relevance_cell));
